...
2. Introdu URL-ul: `https://github.com/alinclaudiu/eonromania` și selectează tipul **Integration**.
...
- ⭐ Oferă un **star** pe [GitHub](https://github.com/alinclaudiu/eonromania/)
- 🐛 **Raportează probleme** — deschide un [issue](https://github.com/alinclaudiu/eonromania/issues)
- 🔀 **Contribuie cu cod** — trimite un pull request
- ☕ **Donează** prin [Buy Me a Coffee](https://buymeacoffee.com/alinclaudiu)
